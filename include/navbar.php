					...
					<div class="container-fluid">
						<div class="city_top_logo">
							...
							<!-- <div class="city_top_logo2">
								<a href="index.php"><img src="images/skill.png" alt=""></a>
							</div> -->
					    ...
					    <div class="city_top_social">
							<div class="wrapper1">
								<div class="icon user">
					               ...
					               <a href="../../seed/seed-admin/admin/index.php" target="_blank"><span><i class="fa fa-user" ></i></span><a>
					            </div>
							...
							<!-- <div class="col-md-12"> -->
								<div class="navigation">
										<ul>
											...
											<li><a href="#">About SEED</a>
												<ul class="child">
													<li><a href="vision-about.php">About us</a></li>
													
													<li><a href="bodolandSEED.php">Bodoland SEED Mission</a></li>
													
													
													
													<li><a href="whos-who.php">Whos's Who</a></li>
											...
											<li><a href="#">ITIs</a>
												<ul class="child">
															...
															<li><a href="link/itikajalgaon/institution/index.php" target="_blank">Industrial Training Institute,Kajalgaon</a></li>
															<li><a href="link/itisalakati/institution/index.php" target="_blank">Industrial Training Institute,Salakati</a></li>
											...
											<li><a href="#">Schemes & Tenders</a>
												<ul class="child">
													...
													<li><a href="report.php">Reports/Documents</a></li>
												</ul>
								...
								<div id="kode-responsive-navigation" class="dl-menuwrapper">
									...
									<ul class="dl-menu">
										...
										<li class="menu-item kode-parent-menu"><a href="#">About Seed</a>
											<ul class="dl-submenu">
												    <li><a href="vision-about.php">About us</a></li>
										...
										<li class="menu-item kode-parent-menu"><a href="#">ITIs</a>
											<ul class="dl-submenu">
													...
													<li><a href="business-detail.php">Industrial Training Institute,Kajalgaon</a></li>
													<li><a href="business-detail.php">Industrial Training Institute,Salakati</a></li>
				...
				<div class="city_top_navigation hide">
					<div class="container-fluid">
						...
						<ul>
							...
							<li><a href="link/LogoCompet/index.php">Logo Competition</a></li>
							<li><a href="resident.html">Reports/Documents</a>
								
							</li>
							<li><a href="resident.html">Useful Links</a>
