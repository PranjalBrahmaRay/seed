							...
							<div class="card card-box">
								<div class="card-body " id="bar-parent">
				                    ...
				                    <table id="example" class="table table-striped table-bordered">
                                        ...
                                        if ($readuser21) {
                                        	$n=0;
                                        	foreach ($readuser21 as $schemes) { ?>
                                        	<tr>
	                                        	<td><?php echo ++$n; ?></td>	
	                                        	
	                                        	<td><img width="100px" src="<?php echo $schemes['image'];?>"></td>
	                                        	<td><?php echo $schemes['head'] ;?></td>
	                                        	<td><?php echo $schemes['title'] ;?></td>
	                                        	<td><?php echo $schemes['description'] ;?></td>	
	                                        	<td><?php echo $schemes['date_uploaded'];?></td>	
	                                        	<!-- <td><a class="tblDelBtn" tabindex="0" aria-controls="example" type="button" a href="#" data-id="<?php echo $schemes['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn"><span><i class="fa fa-pencil"></i> | <i class="fa fa-trash-o"></i></span></a>
												</td> -->
												<td><a href="<?php echo $schemes['id'];?>"  data-id="<?php echo $schemes['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
															</a>
															<a href="javascript:void(0)"  data-id="<?php echo $schemes['id'];?>"  data-target="#model4" data-toggle="modal" class="tblEditBtn">
					...
					<div class="modal fade" id="model4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl">
						    <div class="modal-content">
					      	...
					      	<form action="form/edit_schemes.php" method="post" enctype="multipart/form-data">
	...
	$(document).on("click touch", ".tblEditBtn", function () {
      ...
      $.ajax({
         ...
         success: function(response){
    		...
    		$('#deletePortfolio').attr("href","form/delete_schemes.php?id="+dataId);
